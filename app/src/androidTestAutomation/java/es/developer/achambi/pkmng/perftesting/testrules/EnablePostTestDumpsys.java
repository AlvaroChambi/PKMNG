...
package es.developer.achambi.pkmng.perftesting.testrules;
...
import static es.developer.achambi.pkmng.perftesting.common.PerfTestingUtils.getTestFile;
    ...
    public void before() {
        try {
            ...
            builder.command("dumpsys", "gfxinfo", "--reset",
                    ...
                    es.developer.achambi.pkmng.BuildConfig.APPLICATION_ID);
